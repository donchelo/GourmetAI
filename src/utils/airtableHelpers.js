// Funciones auxiliares compartidas para formatear datos de Airtable
 ...
 */
export const formatParameters = (parametros) => {
 ...
 */
export const generateParametersSummary = (parametros) => {
  if (!parametros || typeof parametros !== 'object') {
    return '';
  }
 ...
 */
export const classifyIngredients = (ingredientesTexto) => {
